        ...
        <PageAnimator>
            ...
            >
                <div className="container position-relative" style={{ zIndex: 2 }}>
                    ...
                    {/* ✅ SEO Friendly H1 */}
                    <h1
                        className="display-3 fw-bold text-info mb-3"
                        style={{ textShadow: '0 0 30px #0dcaf0' }}
                    >
                        Hathisa Thissara
                    </h1>
                    ...
                    <div className="d-flex justify-content-center gap-4 fs-3 my-4">
                        <a href="https://github.com/hathisathissara" className="text-white social-icon" aria-label="GitHub">
                            <FontAwesomeIcon icon={faGithub} />
                        </a>
                        <a href="https://www.linkedin.com/in/hathisa-thissara" className="text-white social-icon" aria-label="LinkedIn">
                            <FontAwesomeIcon icon={faLinkedin} />
                        </a>
                        <a href="mailto:hatheesha6504@gmail.com" className="text-white social-icon" aria-label="Email">
                    ...
                    <div className="d-grid gap-3 d-md-flex justify-content-center">
                        <button className="btn btn-outline-info px-4" onClick={openWhatsAppChat}>
                            Hire Me
                        </button>
                        <a href="/hathisa_thissara_2025.pdf" download className="btn btn-primary px-4">
                            Download CV
                        </a>
                    </div>
                </div>
